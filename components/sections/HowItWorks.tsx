...
export default function HowItWorks() {
  return (
    <section className="bg-woodgrain relative overflow-hidden border-y-4 border-orange-500/30 py-20 sm:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-8">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-display mt-3 text-3xl font-bold text-cream-100 sm:text-4xl">
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-3">
          {HOW_IT_WORKS.map((step, i) => (
            <Reveal key={step.step} delay={i * 0.1} className="text-center">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border-4 border-orange-400 bg-navy-950 font-display text-2xl font-extrabold text-orange-300">
                {step.step}
              </div>
              <h3 className="mt-5 text-lg font-bold text-cream-100">
                {step.title}
              </h3>
