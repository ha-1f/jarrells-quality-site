  ...
  return (
    <section className="bg-navy-900 py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-8">
        <Reveal>
          <div className="flex flex-col items-center justify-between gap-6 rounded-3xl border border-earth-700/40 bg-gradient-to-r from-fire-500/10 via-navy-900 to-ice-400/10 p-8 sm:flex-row sm:p-10">
            ...
            <Link
              href="/financing"
              className="flex shrink-0 items-center gap-2 rounded-full bg-cream-100 px-6 py-3 text-sm font-semibold text-navy-950 transition-transform hover:scale-105"
            >
